          ...
          return (
            <div key={product._id} style={{ border: '1px solid #eaeaea', padding: '20px', borderRadius: '12px', position: 'relative', background: '#fff', boxShadow: '0 2px 8px rgba(0,0,0,0.04)', opacity: isVisualGrayOut ? 0.6 : 1, transition: 'all 0.3s' }}>
              ...
              {isCartMaxedOut && !isDbOutOfStock && (
                <span style={{ position: 'absolute', top: '15px', right: '-10px', background: '#d48806', color: 'white', padding: '4px 10px', fontSize: '0.75rem', fontWeight: 'bold', borderRadius: '4px', zIndex: 10, boxShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>
                  Cart Maxed
                </span>
              )}
